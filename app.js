...
const DEFAULT_GROUPS = [
  ...
  "Summe",
  "Mähwerk 196 = (?=.*M\\S*hwerk)(?=.*\\b(?:196|1[.,]96)(?!\\d))",
  "Mähwerk 238 = (?=.*M\\S*hwerk)(?=.*\\b(?:238|2[.,]38)(?!\\d))",
  "Mähwerk 240 = (?=.*M\\S*hwerk)(?=.*\\b(?:240|2[.,]40?)(?!\\d))",
  "Mähwerk 260 = (?=.*M\\S*hwerk)(?=.*\\b(?:260|2[.,]60?)(?!\\d))",
  "Mähwerk 300 = (?=.*M\\S*hwerk)(?=.*\\b(?:300|3[.,]00?)(?!\\d))",
  "Mähwerk 350 = (?=.*M\\S*hwerk)(?=.*\\b(?:350|3[.,]50?)(?!\\d))",
  "Mähwerk 390 = (?=.*M\\S*hwerk)(?=.*\\b(?:390|3[.,]90?)(?!\\d))",
  "Mähwerk 430 = (?=.*M\\S*hwerk)(?=.*\\b(?:430|4[.,]30?)(?!\\d))",
  "Mähwerk 470 = (?=.*M\\S*hwerk)(?=.*\\b(?:470|4[.,]70?)(?!\\d))",
  "Ino Ibex 145 = (?=.*\\bIno)(?=.*\\b(?:145|1[.,]45)(?!\\d))",
